...
*/
printHeader('ExerciseA')
let test = 'Today is a test day!'
console.log(test)

/* EXERCISE B
    Create a variable called sum and assign to it the result of the sum between the numbers 10 and 20.
*/
printHeader('ExerciseB')
let sum = 10 + 20
console.log(sum)
...
*/
printHeader('ExerciseF')
me.skills = ['JS', 'Ruby', 'Python']
console.log(me)
